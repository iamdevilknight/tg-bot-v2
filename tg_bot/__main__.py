...
I'm An Advanced Group Managing bot Created For @Moviejunction Group 🔥
"""

HELP_STRINGS = """
Hey there! My name is *{}*.
I'm a modular group management bot created for @MovieJunction Group with a few fun extras! Have a look at the following for an idea of some of \
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [
                     [InlineKeyboardButton(text="♻️ JOIN OUR GROUP ♻️", url="https://telegram.dog/MovieJunction")],
                     [InlineKeyboardButton(text="🏷 CHANNEL", url="https://telegram.dog/Mj_Linkz"), InlineKeyboardButton(text="Creator 🖥", url="https://telegram.dog/MasterOfTG")],
                    ]))
